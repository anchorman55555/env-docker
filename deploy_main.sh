...
#
# ВАЖНО: перед запуском этого скрипта выполните инициализацию системы:
#   bash 00_init.sh
# Скрипт настроит DNF, XCP-ng tools, обновит систему, перезагрузится,
# установит базовые пакеты и сгенерирует SSH-ключи.
# ==============================================================================
set -euo pipefail
